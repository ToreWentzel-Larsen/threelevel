...
June 7., 2021, detected that changes have been made in the function rma.mv in version 3.0_0 of the R package metafor, that imply that the shiny app needs to be modified to work properly. The modified app is termed app3.r in this repo while the version
with the newest version 3.0_0 of metafor. Work is in progress to fix the app for use with metafor 3.0_0, but this may take some time. In the meantime, users are adviced to use the app together with the previous version 2.4_0 of metafor.
